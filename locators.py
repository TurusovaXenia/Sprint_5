...
class AuthorizationLocators:
    CONTAINER = (By.CSS_SELECTOR, "form[class^='popUp_shell']")
    CONTAINER_TITLE = (By.CSS_SELECTOR, "form[class^='popUp_shell'] h1")
    EMAIL_FIELD = (By.NAME, "email")
    PASSWORD_FIELD = (By.NAME, "password")
...
class NoticePageLocators:
    ...
    DESCRIPTION_FIELD = (By.CSS_SELECTOR, "div[class^='textarea'] textarea")
    ...
    SELECTED_CONDITION = (By.XPATH, "(.//div[contains(@class, 'radioUnput_shell')]//div)[2]")
    POST_BUTTON = (By.CSS_SELECTOR, "button[type='submit']")

class ProfilePageLocators:
    CONTAINER = (By.CSS_SELECTOR, "div[class^='profilePage_shell']")
    CREATED_NOTICE_NAME = (By.CSS_SELECTOR, "div[class^='grid_threeColumns'] div.card:last-child div.description div.about h2")
